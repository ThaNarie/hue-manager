import type { GroupsDashboardToast } from "./GroupsDashboard.types";

type GroupsDashboardToastsProps = {
  toasts: GroupsDashboardToast[];
  onDismissToast: (toastId: string) => void;
};

export function GroupsDashboardToasts({ toasts, onDismissToast }: GroupsDashboardToastsProps) {
  if (toasts.length === 0) {
    return null;
  }
